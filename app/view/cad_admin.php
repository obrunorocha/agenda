    ...
    <div class="container">
      <div class="row">
        ...
        <div class="bg-light col-sm-4 p-3">
            ...
            <div class="form-group">
              	<label>Senha</label>
              	<input type="password" name="password" id="pass" class="form-control" placeholder="Digite sua senha"> </div>
            <div class="form-group">
              	<label>Confirmar Senha</label>
              	<input type="password" name="confirm" id="confirm" class="form-control" placeholder="Repetir senha"> </div>
            <button type="submit" name="submit" id="submit" class="btn btn-block btn-secondary">Cadastrar</button>
          <p id="admin-message"></p>
          <p class="text-center p-2">Já possui uma conta? <a href="../../app/view/login.php">Efetuar Login!</a></p>
        </div>
      </div>
    </div>
  </div>
